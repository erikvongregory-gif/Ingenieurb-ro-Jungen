...
/**
 * Monochrome FAQ-Sektion (dauerhaft Dark Mode).
 * Design 1:1 wie Vorlage, jedoch:
 *  - Night-/Day-Mode-Umschalter entfernt (wir sind permanent dunkel)
 *  - Inhalte & Überschriften per Props (für zweisprachige Nutzung)
 *  - Schrift erbt unsere Geist-Schrift (kein eigener Font gesetzt)
 */
...
type FaqMonochromeProps = {
  ...
  title?: string;
  subtitle?: string;
  /** Heading-Ebene der Sektionsüberschrift (Default h2). */
  headingAs?: "h1" | "h2";
};
...
export function FaqMonochrome({
  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      >
        <div
          className={`faq1-intro faq1-intro--dark ${introReady ? "faq1-intro--active" : ""}`}
        >
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  style={
                    {
                      "--faq-outline": "rgba(255,255,255,0.35)",
